...
void VolumetricBloodSplatter::Draw(Shader* shader)
{
	...
	if (m_type == 0) {
		...
		m_model = AssetManager::GetModelPtr("blood_mesh");
	}
	else if (m_type == 7) {
		glActiveTexture(GL_TEXTURE0);
		...
		m_model = AssetManager::GetModelPtr("blood_mesh7");
	}
	else if (m_type == 6) {
		glActiveTexture(GL_TEXTURE0);
		...
		m_model = AssetManager::GetModelPtr("blood_mesh6");
	}
	else if (m_type == 8) {
		glActiveTexture(GL_TEXTURE0);
		...
		m_model = AssetManager::GetModelPtr("blood_mesh8");
	}
	else if (m_type == 9) {
		glActiveTexture(GL_TEXTURE0);
		...
		m_model = AssetManager::GetModelPtr("blood_mesh9");
	}
	else if (m_type == 4) {
		glActiveTexture(GL_TEXTURE0);
		...
		m_model = AssetManager::GetModelPtr("blood_mesh4");
	}
