...
{
public: //methods
	static void DrawTextBlit(Shader* shader, const char* text, int xScreenCoord, int yScreenCoord, int renderWidth, int renderHeight, float scale = 1.0f, glm::vec3 color = glm::vec3(1,1,1), bool leftJustified = true);
